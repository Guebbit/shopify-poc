...
export type CartBuyerIdentityUpdateMutation = { cartBuyerIdentityUpdate: { cart: { id: string, totalQuantity: number, cost: { subtotalAmount: { amount: string, currencyCode: CurrencyCode } }, lines: { nodes: Array<
          | { id: string, quantity: number, attributes: Array<{ key: string, value: string | null }>, cost: { totalAmount: { amount: string, currencyCode: CurrencyCode } }, merchandise: { id: string, product: { title: string, vendor: string, featuredImage: { url: string } | null } } }
          | { id: string, quantity: number, attributes: Array<{ key: string, value: string | null }>, cost: { totalAmount: { amount: string, currencyCode: CurrencyCode } }, merchandise: { id: string, product: { title: string, vendor: string, featuredImage: { url: string } | null } } }
        > } } | null, userErrors: Array<{ message: string }> } | null };
...
export type LocalizationQuery = { localization: { availableCountries: Array<{ availableLanguages: Array<{ isoCode: LanguageCode, endonymName: string }> }> } };
